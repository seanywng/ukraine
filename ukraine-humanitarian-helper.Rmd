...
[![sources scatterplot](./plots/sources_scatter.png)](https://raw.githubusercontent.com/seanywng/ukraine-humanitarian-helper/main/plots/sources_scatter.png){target="_blank"}
*[Full-sized plot](https://raw.githubusercontent.com/seanywng/ukraine-humanitarian-helper/main/plots/sources_scatter.png){target="_blank"}*
...
As can be seen from the scatterplot above, the main actors in the response are immediately visible, whether they be UN, NGOs or donors, 
